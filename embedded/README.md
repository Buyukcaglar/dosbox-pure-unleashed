...
`phase3-smoke.dosz` is a license-safe development fixture embedded into the Visual Studio executable as `IDR_EMBEDDED_ARCHIVE` `RCDATA` resource 101.
...
The fixture is temporary development packaging content. The Phase 7 package builder will replace it with a selected game archive and matching package metadata.
